...
using System.Web;
using System.Data;
using OSNProject.DLTableAdapters;
...
namespace OSNProject
{
    ...
    public class BLL
    {
        ...
        public void InsertUser(string emailId, string password, string fName, string lName, string gender, string dob, DateTime date)
        {
        ...
        public DataTable GetDatasetByDate(DateTime sDate, DateTime eDate)
        {
            return userObj.GetDatasetByDate(sDate, eDate);
        }
        ...
        public void UpdateCT(string CT, int CTID)
        {
            contenttypeObj.UpdateCT(CT, CTID);
        }
        ...
        public void SendFriendRequest(string from, string to, DateTime date, string status)
        {
        ...
        public DataTable GetFriendRequestsByDate(DateTime sDate, DateTime eDate)
        {
            return friendrequestObj.GetFRDatasetByDate(sDate, eDate);
        }
        ...
        public void UpdateKeyword(int CTID, string keyword, int keyId)
        {
            keywordObj.UpdateKeyword(CTID, keyword, keyId);
        }
