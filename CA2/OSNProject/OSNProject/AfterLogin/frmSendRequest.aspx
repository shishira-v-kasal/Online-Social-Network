<%@ Page Title="" Language="C#" MasterPageFile="~/AfterLogin/UserMasterpage.Master" AutoEventWireup="true" CodeBehind="frmSendRequest.aspx.cs" Inherits="OSNProject.AfterLogin.frmSendRequest" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<asp:Panel ID="panel" runat="server">  

 <div class="header_02">User Profile!</div>
    <br />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnRequest" runat="server" onclick="btnRequest_Click" 
                                Text="Send Friend Request" Width="250px" />
                        </td>
                    </tr>
                </table>
