...
{
    public partial class frmFindFriends : System.Web.UI.Page
    {
        ...
        private void GetUsers()
        {
            ...
            if (tab.Rows.Count > 0)
            {
                ...
                for (int cnt = 0; cnt < tab.Rows.Count; cnt++)
                {
                    ...
                    hypMore.NavigateUrl = string.Format("frmUserBasicDetails.aspx?UserId={0}", tab.Rows[cnt]["EmailId"].ToString());
