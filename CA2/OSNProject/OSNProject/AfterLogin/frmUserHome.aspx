<%@ Page Title="" Language="C#" MasterPageFile="~/AfterLogin/UserMasterpage.Master" AutoEventWireup="true" CodeBehind="frmUserHome.aspx.cs" Inherits="OSNProject.frmUserHome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <asp:Panel ID="panel" runat="server">   
   <div class="container">
		<div class="about row">
			<h2>View Notifications and Fake Accounts Prediction!!!</h2>
    <br />
         ...
         <tr>
             ...
             <td>
                 <asp:RadioButton ID="rbtnFriendRequests" runat="server" AutoPostBack="True" 
                     ...
                     Text="Follow Requests" GroupName="a" />
             </td>
         </tr>
     </table>
     <br />
