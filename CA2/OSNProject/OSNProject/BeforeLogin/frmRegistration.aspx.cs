    ...
    public partial class frmRegistration : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                OSNProject.JQueryUtils.RegisterTextBoxForDatePicker(Page, txtDOB);
            }
            catch
            {
        ...
        protected void imagebtnRegister_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                if (obj.CheckUserId(txtEmailId.Text))
                {
                    ...
                    obj.InsertUser(txtEmailId.Text, txtPassword.Text, txtFirstName.Text, txtLastName.Text, dropdownlistGender.SelectedValue, s[2], DateTime.Now);
