<%@ Page Title="" Language="C#" MasterPageFile="~/Member/MemberMasterpage.Master" AutoEventWireup="true" CodeBehind="InfoSharing.aspx.cs" Inherits="SocialNetworking.Member.InfoSharing" %>
...
<asp:Panel ID="Panel1" runat="server">
     ...
     <div class="header_02">Information Sharing Module!!!</div>
    <br />
        ...
        <asp:Panel ID="PanelSharedInformation" runat="server">
         <div class="header_02">View Your Shared Information!!!</div>
