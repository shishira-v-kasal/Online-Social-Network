<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterpage.Master" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="SocialNetworking.Admin.AdminHome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <asp:Panel ID="Panel1" runat="server">
     ...
     <div class="header_02">View Registered Members!</div>
    <br />
