<%@ Page Title="" Language="C#" MasterPageFile="~/Visitor/MainMasterpage.Master" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="SocialNetworking.Visitor.AdminLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server">
     ...
     <div class="header_02">Admin Login Form!</div>
    <br />
