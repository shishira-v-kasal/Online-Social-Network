<%@ Page Title="" Language="C#" MasterPageFile="~/Visitor/MainMasterpage.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="SocialNetworking.Visitor.Register" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

 <asp:Panel ID="Panel1" runat="server">
     <div class="header_02">Registration Form for New Users!</div>
    <br />
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:ImageButton ID="imagebtnRegister" runat="server" Height="55px" 
                                    ImageUrl="~/img/registericon.png" Width="180px" 
